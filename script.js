    ...
    // Si Parte - Controlla le dimensioni dello schermo
    window.onload = function() {
      verificaDimensioniSchermo();
  
      // Aggiungo anche un listener di eventi per il ridimensionamento della finestra
    ...
    function popolaLayout () {
      ...
      if (indiceCorrente<questions.length) {
        ...
        let tempoRimanente = 10; // 20 secondi
